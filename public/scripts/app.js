...
(function(window, document, $) {
    ...
    $(window).on('load',function(){
        ...
        if(menuType != 'vertical-compact-menu' && menuType != 'horizontal-menu' && menuType != 'horizontal-top-icon-menu'){
            $(".main-menu-content").find('li.selected').parents('li').addClass('open');
        }
        if(menuType == 'vertical-compact-menu' || menuType == 'horizontal-menu' || menuType == 'horizontal-top-icon-menu'){
            $(".main-menu-content").find('li.selected').parents('li:not(.nav-item)').addClass('open');
            $(".main-menu-content").find('li.selected').parents('li').addClass('selected');
        }
