      ...
      update: function() {
        if (this.obj) {
          ...
          if($('.main-menu').data('scroll-to-active') === true){
              var position;
              if( $(".main-menu-content").find('li.selected').parents('li').length > 0 ){
                position = $(".main-menu-content").find('li.selected').parents('li').last().position();
              }
              else{
                position = $(".main-menu-content").find('li.selected').position();
              }
              setTimeout(function(){
